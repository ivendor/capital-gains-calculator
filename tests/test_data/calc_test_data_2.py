...
calc_basic_data_2 = [
    ...
    pytest.param(
        ...
        [
            ...
            eri_transaction(
                date=datetime.date(day=1, month=7, year=2023), symbol="FOO", price=2.1
            ),
            sell_transaction(
    ...
    pytest.param(
        ...
        [
            ...
            eri_transaction(
                date=datetime.date(day=1, month=9, year=2020), symbol="MSP", price=0.4
            ),
            buy_transaction(
        ...
        None,  # Current prices
        0.00,  # Expected UK interest
        2400.00,  # Expected foreign interest
        0.00,  # Expected dividend
        0.00,  # Expected dividend gain
        {
